...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-mgmt-web-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9774&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-mgmt-web-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-web` can be installed with:

```
conda install azure-mgmt-web
```

It is possible to list all of the versions of `azure-mgmt-web` available on your platform with:
